...
/**
 * 火山 CodingPlan 供应商 — 支持 Chat Completions 和 Anthropic Messages 两种端点。
 */
@Component
public class VolcCodingPlanProviderClient implements AiProviderClient {
    ...
    public ProviderType type() {
        return ProviderType.VOLC_CODINGPLAN;
    }
    ...
    public ProviderQuota quota(ProviderQuotaFetchRequest request) {
        return new ProviderQuota(false, "火山 CodingPlan 暂不支持通用余额查询，请在供应商控制台查看。",
                null, null, null, "", "");
    }
}
