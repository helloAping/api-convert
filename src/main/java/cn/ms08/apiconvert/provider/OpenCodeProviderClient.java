...
@Component
public class OpenCodeProviderClient extends BaseAiProviderClient {
    ...
    @Override
    public ProviderType type() { return ProviderType.OPENCODE; }
    ...
    public ProviderQuota quota(ProviderQuotaFetchRequest request) {
        return new ProviderQuota(false, "OpenCode 暂不支持通用余额查询", null, null, null, "", "");
    }
